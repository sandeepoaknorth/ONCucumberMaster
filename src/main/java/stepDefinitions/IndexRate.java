...
public class IndexRate extends DriverFactory {
    ...
    public void user_provides_valid_index_rate_setup_inputs_(String indextype, String name, String currency, String tenorvalue, String tenorfrequency, String testscenario) throws Throwable {
    ...
    public void index_details_appears_under_interest_rate_index_list_table(String rateIndex, String name, String currency, String tenorvalue, String tenorfrequency) throws Throwable {
