...
public class InterestRateMaintenance extends DriverFactory {
	...
	public void user_should_see_all_ui_elements_of_something_page() {
		interestRateMaintenancePage.assertString(interestRateMaintenancePage.getRateMaintenanceHeaderVerbiage(),
				prop.getProperty("rateMaintenanceHeader"));
		interestRateMaintenancePage.assertString(interestRateMaintenancePage.getBusinessDateVerbiage(),
				prop.getProperty("businessDate"));
		interestRateMaintenancePage.assertString(interestRateMaintenancePage.getReferenceRateVerbiage(),
				prop.getProperty("referenceRate"));
		interestRateMaintenancePage.assertString(interestRateMaintenancePage.getValueInputVerbiage(),
				prop.getProperty("valueInput"));
		interestRateMaintenancePage.assertString(interestRateMaintenancePage.getHistoricRateHeaderVerbiage(),
				prop.getProperty("historicRateHeader"));
		interestRateMaintenancePage.assertString(interestRateMaintenancePage.getFiltorVerbiage(),
				prop.getProperty("filtor"));
		interestRateMaintenancePage.checkDropDown(interestRateMaintenancePage.getTableColumnVerbiages(),
				prop.getProperty("tableColumn1"), prop.getProperty("tableColumn2"), prop.getProperty("tableColumn3"),
				prop.getProperty("tableColumn4"));
	}
	...
	public void user_provides_all_mandatory_details_like_(String businessdate, String currency, String referencerate,
			String value, String testscenario) throws Throwable {
	...
	public void provided_interest_details_should_be_added_and_visible_under_historic_dates_table(String businessdate,
			String referencerate, String value) throws Throwable {
